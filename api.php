...
require Bundle::path('ucenter').'callback.php';
...
{	
	static function execute()
	{
		...
		{
			$callback = new uc_api_callback();
			return $callback->$get['action']($get, $post);
		} 
		else 
		{
	...
	public static function serialize($arr, $htmlon = 0)
	{
		...
		{
			include Bundle::path('ucenter').'uc_client/lib/xml.class.php';
		}
...
/**
 * trick for Autoloader
 * don't modify or delete this.
 */
class_alias('UC_Api', 'UC_Client');